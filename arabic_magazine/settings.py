"""
Django settings for arabic_magazine project.
...
SECRET_KEY = 'wz$n*oh=l+&fbv5%=nh%gb#-#u++wn#w1rk5xv&x$!vd#-ms%7'
...
ROOT_URLCONF = 'arabic_magazine.urls'
...
WSGI_APPLICATION = 'arabic_magazine.wsgi.application'
...
AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME','alnakheel-bucket')
